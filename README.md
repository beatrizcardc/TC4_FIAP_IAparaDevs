...
## 😊 Emoções detectadas (eventos únicos):
- 😐 **Neutral**: 47 vezes
- 😢 **Sad**: 60 vezes
- 😨 **Fear**: 15 vezes
- ❓ **Not detected**: 39 vezes
- 😊 **Happy**: 31 vezes
- 😠 **Angry**: 21 vezes
- 😲 **Surprise**: 10 vezes
...
- ✋ (Dir) **Mao direita levantada**: 20 vezes
- 🙌 **Maos levantadas**: 13 vezes
- 💃 **Dancando**: 1 vezes
- 🤝 **Aperto de maos**: 2 vezes

## 📸 Imagens de Anomalias e Atividades Destacadas:

### 🔍 Atividade: **Dancando**
- dancando_frame_605.jpg

### 🔍 Atividade: **Aperto de maos**
- aperto_de_maos_frame_2008.jpg
- aperto_de_maos_frame_3106.jpg
...
📦 projeto
 ...
 ┣ 📜 aplicação            # Aplicação "limpa" e do processo
   ...
   - https://github.com/beatrizcardc/TC4_FIAP_IAparaDevs/blob/main/tc4_v49%20(processo).py         - aplicação do processo
...
Desafio inicial:
  ...
  - Falsos positivos na detecção de atividades, como confundir o movimento de lábios com "mão levantada" ou movimentos bruscos como "dança".
